...
<div class="container main-content">
    <!-- Body -->
    <div>
        <h3 class="title">Sửa câu hỏi Part 1</h3>
    </div>
    <div class="col-md-12">
        <?php
        ...
        foreach ($gquestion as $key => $value){
            ...
            $proCode = '<form method="post" enctype= "multipart/form-data" action="'.base_url().'YiZSzkTGaa/savePart5Quest/'.$gID.'">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="vMp3url" class="form-control" value="'.$mp3url.'">
                        </div>
                        <div class="form-group">
                            <label for="inputPassword3">Question 1</label>
                            <input type="file" id="exampleInputFile" name="vUpImgThumbnail" accept="image/*">
                            <input type="text" name="vImgThumbnail" class="form-control" readonly value="'.$quest.'">
